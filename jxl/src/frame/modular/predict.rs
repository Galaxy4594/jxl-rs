...
impl WeightedPredictorState {
    pub fn new(wp_header: &WeightedHeader, xsize: usize, is_float: bool) -> WeightedPredictorState {
...
mod tests {
    ...
    fn predict_and_update_errors() {
        ...
        let xsize = 8;
        let ysize = 8;
        let mut state = WeightedPredictorState::new(&header.wp_header, xsize, false);
